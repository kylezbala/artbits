            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="card-title"><h3>Post an Art</h3></div>
                        ...
                        <h4 style="font-family: Verdana;">Art Category</h4><select class="form-control" name="category_id">
                    ...
                    <button type="Submit" class="btn btn-primary" name="submit" value="Enter information">Submit</button>
